    ...
    return (
        <article className="rounded-2xl border border-stone-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-5 grid gap-3 text-sm sm:grid-cols-2">
                ...
                <div>
                    <p className="font-medium text-stone-700">Brand</p>
                ...
                <div>
                    <p className="font-medium text-stone-700">Color</p>
                    <p className="text-stone-600">
                ...
                <div>
                    <p className="font-medium text-stone-700">Reporter ID</p>
