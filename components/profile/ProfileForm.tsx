...
// เบอร์โทรไทย รูปแบบ 0xx-xxx-xxxx เช่น 081-234-5478
const PHONE_REGEX = /^0[0-9]{2}-[0-9]{3}-[0-9]{4}$/;

function isValidPhone(value: string): boolean {
  if (!value) return true; // เบอร์โทรเป็น optional
...
export default function ProfileForm({
  ...
  const [savedPhone, setSavedPhone] = useState(initialProfile.phone);
  ...
  return (
    ...
    >
      <section className="ui-card">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-1.5 text-xs text-[var(--foreground-muted)]">
              Optional — รูปแบบ 0xx-xxx-xxxx เช่น 081-234-5478
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="flex justify-end">
        <button
          type="submit"
          disabled={saving || !hasChanges || !cleanFullName}
